...
import { BagDialogComponent, PieceConfirmDialogComponent, BagConfirmDialogComponent, BagEditDialogComponent } from 'src/app/shared/dialogs';
...
@NgModule({
  ...
  entryComponents: [BagDialogComponent, PieceConfirmDialogComponent, BagConfirmDialogComponent, BagEditDialogComponent]
})
